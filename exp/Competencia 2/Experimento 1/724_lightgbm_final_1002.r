...
PARAM$finalmodel$learning_rate     <-    0.005167243
PARAM$finalmodel$num_iterations    <-    750
PARAM$finalmodel$num_leaves        <-    41
PARAM$finalmodel$min_data_in_leaf  <-    788
PARAM$finalmodel$feature_fraction  <-    0.423893723

PARAM$finalmodel$semilla           <-    113111
 
#PARAM$finalmodel$corte           <-      8429	8489	8549	8609	8669	8729	8789	8849	8909	8969	9029	9089	9149	9209	9269	9329
