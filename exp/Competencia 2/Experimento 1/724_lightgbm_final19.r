...
PARAM$finalmodel$learning_rate     <-    	0.005005274# 0.005092466	0.020567149	0.008016778	0.007095026	0.021438255	0.005005634
PARAM$finalmodel$num_iterations    <-     1057#	538	203	515	592	195	862
PARAM$finalmodel$num_leaves        <-    	252#	190	391	80	289	469	392
PARAM$finalmodel$min_data_in_leaf  <-    	2416#	725	1103	1791	706	1548	2239
PARAM$finalmodel$feature_fraction  <-    	0.369789109#	0.368892489	0.365311167	0.378358382	0.381423653	0.398290003	0.379513657
...
archivo_importancia  <- "impo19.txt"
