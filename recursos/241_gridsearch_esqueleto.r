...
ksemillas  <- c(113111, 742111, 724111, 725111, 644131, 734131 ) #reemplazar por las propias semillas
semilla <-c(113111)
#------------------------------------------------------------------------------
...
setwd("C:\\gdrive\\UBA2022\\test\\")   #Establezco el Working Directory
#cargo los datos
...
for( cp  in  c(0.25, 0.5, 0.75, 0.9)  ) #defecto 0.01
{
for( vmax_depth  in  c( 6, 8, 12, 16, 20, 24, 28, 30, 32, 34, 36  )  ) #defecto 30
{
for( vmin_split  in  c( 200, 100, 50, 25, 23, 21, 20, 19, 18, 15, 13, 11, 10)  )
{
#for( minbucket in  c( minsplit/4, minsplit/3, minsplit/2)  ) #defecto minsplit/3 https://www.rdocumentation.org/packages/rpart/versions/4.1.16/topics/rpart.control
#{
  #notar como se agrega
  minbucket <- vmin_split/3
