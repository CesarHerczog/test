                                                  ...
                                                  for( poda12 in c(5) ){
                                                    for( poda13 in c(5) ){
                                                      ...
                                                      for( i in 1:1000 ) { #diez mil experimentos
                                                        ...
                                                        planilla_cazatalentos[ ids_juegan7,  suma_de_margenes1 := (margen1+margen2+margen3+margen4+margen5+margen6)*100 ] 
                                                        ...
                                                        #Ultima Ronda -------------------------------------------------------
                                                        #eliminación a los que tuvieron muchos juegos por debajo del promedio
                                                        planilla_cazatalentos[ ids_juegan12,  suma_de_margenes := (margen1+margen2+margen3+margen4+margen5+margen6+margen7+margen8+margen9+margen10+margen11+margen12)*100 ] 
