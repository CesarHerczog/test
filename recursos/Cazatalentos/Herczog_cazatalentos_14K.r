...
for( i in 1:10000 ) { #diez mil experimentos
  ...
  poda_r1 <- 1    #Solo la declaro para imprimir al final
  poda_r2 <- 1 #(tiros_r1) * 99 / 411 #Elimino al los que estan por debajo de percentil  
  poda_r3 <- 1 #(tiros_r1 + tiros_r2) * 99 / 411  #Elimino al los que estan por debajo de percentil  
  poda_r4 <- 1 #30(tiros_r1 + tiros_r2 + tiros_r3) * 99 / 411  #Elimino al los que estan por debajo de percentil  
  poda_r5 <- 1 #(tiros_r1 + tiros_r2 + tiros_r3 + tiros_r4) * 99 / 411  #Elimino al los que estan por debajo de percentil  
  poda_r6 <- 1 #(tiros_r1 + tiros_r2 + tiros_r3 + tiros_r4 + tiros_r5) * 99 / 411  #Elimino al los que estan por debajo de percentil  
  poda_r7 <- 1 #(tiros_r1 + tiros_r2 + tiros_r3 + tiros_r4 + tiros_r5 + tiros_r6) * 99 / 411 #Elimino al los que estan por debajo de percentil  

  poda_mediana_magica <- 0.62 #Valor de 0 a 1 en que se selecciona el limite de la mediana de tasa de aciertos
  ...
  planilla_cazatalentos$mediana_magica <- apply(planilla_cazatalentos[, c("margen1" ,"margen2" ,"margen3" ,"margen4" ,"margen5" ,"margen6")], 1, median)
  ...
  ids_juegan7  <- planilla_cazatalentos[ ids_juegan7 ][mediana_magica > poda_mediana_magica, id ]
...
cat(poda_r1 , poda_r2, poda_r3, poda_r4, poda_r5, poda_r6, poda_r7, poda_mediana_magica, MAX_GLOBAL_tiros_total, tasa_de_aciertos/100, "\n" )
