...
modelo  <- rpart(formula=   "clase_binaria ~ . -Visa_mpagado -ctrx_quarter -mcomisiones_mantenimiento -clase_ternaria",
...
for( corte  in  c( 4000, 5000, 6000, 7000, 8000, 9000, 9500, 10000, 10500, 11000 ) )
{
  ...
  fwrite( dfinal[ , list(numero_de_cliente, Predicted) ], #solo los campos para Kaggle
           file= paste0( "./exp/KA113111/20220905x_KA113111_005_",  corte, ".csv"),
           sep=  "," )
}
