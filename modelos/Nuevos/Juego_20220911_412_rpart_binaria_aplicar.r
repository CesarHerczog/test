...
modelo  <- rpart(formula=   "clase_binaria ~ .  -clase_ternaria -ctrx_quarter", #-ctrx_quarter
                 data=      dtrain,  #los datos donde voy a entrenar
                 xval=          0,
                 cp=        -0.54,   #-0.89 -0.54
                 minsplit=   1180,   # 621  1073
                 minbucket=   281,   # 309   278
                 maxdepth=      8 )  #  12     9
...
for( corte  in  c( 7784, 8625, 9407, 9693, 10147 ) )
{
  ...
  fwrite( dfinal[ , list(numero_de_cliente, Predicted) ], #solo los campos para Kaggle
           file= paste0( "./exp/KA113111/20220911_Juego_",  corte, ".csv"),
           sep=  "," )
}
