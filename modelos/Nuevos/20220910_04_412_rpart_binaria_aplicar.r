...
modelo  <- rpart(formula=   "clase_binaria ~ .  -clase_ternaria ", #-ctrx_quarter
                 ...
                 xval=          0,
                 cp=       -0.578,   #-0.89 -0.54
                 minsplit=   1298,   # 621  1073
                 minbucket=   274,   # 309   278
                 maxdepth=      9 )  #  12     9
...
for( corte  in  c( 4800, 6640, 7058, 7655, 8370, 8714, 9474, 10281, 11750, 12150, 12950, 14500 ) )
{
  ...
  fwrite( dfinal[ , list(numero_de_cliente, Predicted) ], #solo los campos para Kaggle
           file= paste0( "./exp/KA113111/20220910_Few_new_features_PERCENT_",  corte, ".csv"),
           sep=  "," )
}
