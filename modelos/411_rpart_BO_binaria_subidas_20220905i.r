...
hs  <- makeParamSet(
          ...
          makeIntegerParam("maxdepth" , lower=   7L,  upper=   7L),  #la letra L al final significa ENTERO
...
ArbolSimple  <- function( fold_test, data, param )
{
  ...
  #genero el modelo
  modelo  <- rpart("clase_binaria ~ .   -Visa_mpagado -ctrx_quarter -mcomisiones_mantenimiento -clase_ternaria -Visa_status -Master_status",
...
archivo_log  <- "HT20220905i.txt"
archivo_BO   <- "HT20220905i.RDATA"
