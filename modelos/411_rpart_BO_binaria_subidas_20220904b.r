...
hs  <- makeParamSet(
          makeNumericParam("cp"       , lower=  -0.9, upper=    -0.3),
          makeNumericParam("minsplit" , lower=   250,   upper= 2000 ),
          makeNumericParam("minbucket", lower=   1,   upper= 2000 ),
          makeIntegerParam("maxdepth" , lower=   3L,  upper=   100L),  #la letra L al final significa ENTERO
...
ArbolSimple  <- function( fold_test, data, param )
{
  ...
  #genero el modelo
  modelo  <- rpart("clase_binaria ~ .  -Visa_mpagado -mcomisiones_mantenimiento -clase_ternaria -ctrx_quarter -Visa_status -Master_status",
...
archivo_log  <- "HT20220904b.txt"
archivo_BO   <- "HT20220904b.RDATA"
