...
modelo  <- rpart(formula=   "clase_binaria ~ . -mcaja_ahorro -Visa_mpagado -ctrx_quarter -mcomisiones_mantenimiento -clase_ternaria -Visa_status -Master_status",
...
for( corte  in  c( 8700, 10500 ) )
{
  ...
  fwrite( dfinal[ , list(numero_de_cliente, Predicted) ], #solo los campos para Kaggle
           file= paste0( "./exp/KA113111/20220905g2_KA113111_005_",  corte, ".csv"),
           sep=  "," )
}
