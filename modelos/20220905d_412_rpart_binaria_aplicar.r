...
#20220905d pruebo crear el ctrx_quarter < 14
...
dataset[ ,ctrx_quarter :=  ifelse( ctrx_quarter < "CONTINUA", "NO", "SI" ) ]
...
modelo  <- rpart(formula=   "clase_binaria ~ .  -Visa_mpagado -mcomisiones_mantenimiento -clase_ternaria -Visa_status -Master_status",
...
for( corte  in  c( 10000, 10500 ) )
{
  ...
  fwrite( dfinal[ , list(numero_de_cliente, Predicted) ], #solo los campos para Kaggle
           file= paste0( "./exp/KA113111/20220905c_KA113111_005_",  corte, ".csv"),
           sep=  "," )
}
