...
#Creo 4 features nuevos (CTRX_QUARTER, Visa_status, mcuentas_saldo y uno con master_status y Visa_status)
...
modelo  <- rpart(formula=   "clase_binaria ~ .  -Visa_mpagado -mcomisiones_mantenimiento -clase_ternaria -ctrx_quarter",
...
for( corte  in  c( 7500, 8000, 8500, 9000, 9500, 10000, 10500, 11000, 11500, 12000 ) )
{
  ...
  fwrite( dfinal[ , list(numero_de_cliente, Predicted) ], #solo los campos para Kaggle
           file= paste0( "./exp/KA113111/KA113111_20220904b4_005_",  corte, ".csv"),
           sep=  "," )
}
