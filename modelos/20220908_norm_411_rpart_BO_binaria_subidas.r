...
hs  <- makeParamSet(
          ...
          makeNumericParam("minsplit" , lower=   730L,   upper= 1500L ),
          makeNumericParam("minbucket", lower=   29L,   upper= 370L ), #lower=   29L,   upper= 75L ),
...
archivo_log  <- "HT20220908x2.txt"
archivo_BO   <- "HT20220908x2.RDATA"
